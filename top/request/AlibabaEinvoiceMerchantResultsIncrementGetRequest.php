<?php
/**
 * TOP API: alibaba.einvoice.merchant.results.increment.get request
 * 
 * @author auto create
 * @since 1.0, 2018.07.25
 */
class AlibabaEinvoiceMerchantResultsIncrementGetRequest
{
	/** 
	 * 终止查询时间
	 **/
	...
	{
		return "alibaba.einvoice.merchant.results.increment.get";
	}
